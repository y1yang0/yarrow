...
public class ArithmeticInstr extends Op2Instr {
    ...
    public String toString() {
        ...
        switch (super.opcode){
            ...
            case Bytecode.LADD:
            case Bytecode.FADD:
            case Bytecode.DADD:op='+';break;
            case Bytecode.ISUB:
            case Bytecode.LSUB:
            case Bytecode.FSUB:
            case Bytecode.DSUB:op='-';break;
            case Bytecode.IMUL:
            case Bytecode.LMUL:
            case Bytecode.FMUL:
            case Bytecode.DMUL:op='*';break;
            case Bytecode.IDIV:
            case Bytecode.LDIV:
            case Bytecode.FDIV:
            case Bytecode.DDIV:op='/';break;
            case Bytecode.IREM:
            case Bytecode.LREM:
            case Bytecode.FREM:
            case Bytecode.DREM:op='%';break;
            default:
                CompilerErrors.shouldNotReachHere();
        }

        return Logger.f("i{}: i{} {} i{}",super.id,super.left.id,op,super.right);
    }
}
